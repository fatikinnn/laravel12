<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('rme.igd.index') }}" class="nav-link {{ request()->routeIs('rme.igd.*') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ request()->routeIs('laporan-kronis.*') || request()->routeIs('resep-kronis.*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ request()->routeIs('laporan-kronis.*') || request()->routeIs('resep-kronis.*') ? 'active' : '' }}">
    ...
    <ul class="nav nav-treeview">
        <li class="nav-item">
            <a href="{{ route('resep-kronis.index') }}" class="nav-link {{ request()->routeIs('resep-kronis.*') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ route('laporan-kronis.index') }}" class="nav-link {{ request()->routeIs('laporan-kronis.*') ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>Filter Obat</p>
            </a>
        </li>
