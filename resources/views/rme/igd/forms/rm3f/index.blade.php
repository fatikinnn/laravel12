...
<div class="card-body">
    <form id="form-rm3f-submit" action="{{ route('rme.igd.form.rm3f.store') }}" method="POST">
        ...
        <div class="table-responsive">
            <table class="table table-bordered mb-4">
                <thead class="table-success">
                    <tr><th colspan="2"><h5>ASESMEN AWAL</h5></th></tr>
                </thead>
                <tbody>
                    <tr>
                        <td width="30%"><label for="KELUHAN" class="form-label"><strong>Keluhan Utama:</strong></label></td>
                        <td><textarea id="KELUHAN" name="KELUHAN" class="form-control" rows="2">{{ getValueRm3f($row, 'KELUHAN', '') }}</textarea></td>
                    </tr>
                    <tr>
                        <td><label for="RIWAYAT_PS" class="form-label"><strong>Riwayat Penyakit Sekarang:</strong></label></td>
                        <td><textarea id="RIWAYAT_PS" name="RIWAYAT_PS" class="form-control" rows="2">{{ getValueRm3f($row, 'RIWAYAT_PS', '') }}</textarea></td>
                    </tr>
                    <tr>
                        <td><label for="RIWAYAT_PD" class="form-label"><strong>Riwayat Penyakit Dahulu:</strong></label></td>
                        <td><textarea id="RIWAYAT_PD" name="RIWAYAT_PD" class="form-control" rows="2">{{ getValueRm3f($row, 'RIWAYAT_PD', '') }}</textarea></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-bordered mb-4">
                <thead class="table-success">
                    <tr><th colspan="3"><h3 class="h5 mb-0">SISTEM TUBUH</h3></th></tr>
                </thead>
                <tbody>
                    <!-- Tekanan Intrakranial -->
                    <tr>
                        <td width="30%"><strong>Tekanan Intrakranial:</strong></td>
                        <td>
                    ...
                    <tr>
                        <td><strong>Neuro Sensorik/Muskuloskeletal:</strong></td>
                        <td>
                    ...
                    <!-- Integument -->
                    <tr>
                        <td><strong>Integument:</strong></td>
                        <td>
                    ...
                    <!-- Mukosa Mulut -->
                    <tr>
                        <td><strong>Mukosa Mulut:</strong></td>
                        <td colspan="2">
                    ...
                    <!-- Perdarahan -->
                    <tr>
                        <td><strong>Perdarahan:</strong></td>
                        <td colspan="2">
                            ...
                            <div id="perdarahan-detail" class="mt-2" style="display: {{ isCheckedRm3f($row, 'PERDARAHAN') ? 'block' : 'none' }};">
                                <div class="row g-2">
                                    <div class="col-md-6"><label for="PERDARAHAN_JUMLAH" class="form-label">Jumlah Perdarahan:</label><input type="text" id="PERDARAHAN_JUMLAH" name="PERDARAHAN_JUMLAH" class="form-control" value="{{ getValueRm3f($row, 'PERDARAHAN_JUMLAH') }}"></div>
                                    <div class="col-md-6"><label for="PERDARAHAN_WARNA" class="form-label">Warna Perdarahan:</label><input type="text" id="PERDARAHAN_WARNA" name="PERDARAHAN_WARNA" class="form-control" value="{{ getValueRm3f($row, 'PERDARAHAN_WARNA') }}"></div>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <!-- Intoksikasi -->
                    <tr>
                        <td><strong>Intoksikasi:</strong></td>
                        <td>
                            <div class="form-check"><input class="form-check-input" type="checkbox" name="INTOKSIKASI_TIDAK" value="1" id="INTOKSIKASI_TIDAK" {{ isCheckedRm3f($row, 'INTOKSIKASI_TIDAK') }}><label class="form-check-label" for="INTOKSIKASI_TIDAK">Tidak</label></div>
                            <div class="form-check"><input class="form-check-input" type="checkbox" name="INTOKSIKASI_MAKANAN" value="1" id="INTOKSIKASI_MAKANAN" {{ isCheckedRm3f($row, 'INTOKSIKASI_MAKANAN') }}><label class="form-check-label" for="INTOKSIKASI_MAKANAN">Makanan</label></div>
                            <div class="form-check"><input class="form-check-input" type="checkbox" name="INTOKSIKASI_GIGIT" value="1" id="INTOKSIKASI_GIGIT" {{ isCheckedRm3f($row, 'INTOKSIKASI_GIGIT') }}><label class="form-check-label" for="INTOKSIKASI_GIGIT">Gigitan Binatang</label></div>
                        </td>
                        <td>
                            <div class="form-check"><input class="form-check-input" type="checkbox" name="INTOKSIKASI_ZAT" value="1" id="INTOKSIKASI_ZAT" {{ isCheckedRm3f($row, 'INTOKSIKASI_ZAT') }}><label class="form-check-label" for="INTOKSIKASI_ZAT">Zat Kimia</label></div>
                            <div class="form-check"><input class="form-check-input" type="checkbox" name="INTOKSIKASI_GAS" value="1" id="INTOKSIKASI_GAS" {{ isCheckedRm3f($row, 'INTOKSIKASI_GAS') }}><label class="form-check-label" for="INTOKSIKASI_GAS">Gas</label></div>
                            <div class="form-check"><input class="form-check-input" type="checkbox" name="INTOKSIKASI_OBAT" value="1" id="INTOKSIKASI_OBAT" {{ isCheckedRm3f($row, 'INTOKSIKASI_OBAT') }}><label class="form-check-label" for="INTOKSIKASI_OBAT">Obat</label></div>
                        </td>
                    </tr>
                    <!-- Eliminasi -->
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="row g-2">
                                <div class="col-12 mb-2"><h6 class="text-primary fw-bold border-bottom pb-1">BAB</h6></div>
                                <div class="col-md-3">
        ...
        <!-- Pengkajian Primer -->
        <div class="card mb-4">
            <div class="card-header bg-success text-white"><h3 class="h5 mb-0">PENGKAJIAN PRIMER</h3></div>
            <div class="card-body">
                <!-- Airway -->
                <div class="mb-4 border-bottom pb-3">
                    <h4 class="h5 mb-3 text-success"><i class="fas fa-lungs me-2"></i><strong>Airway</strong></h4>
                    <div class="row row-cols-2 row-cols-md-3 g-2">
                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="AIRWAY_SUMBAT" value="1" id="AIRWAY_SUMBAT" {{ isCheckedRm3f($row, 'AIRWAY_SUMBAT') }}><label class="form-check-label" for="AIRWAY_SUMBAT">Sumbatan</label></div></div>
                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="AIRWAY_BENDA" value="1" id="AIRWAY_BENDA" {{ isCheckedRm3f($row, 'AIRWAY_BENDA') }}><label class="form-check-label" for="AIRWAY_BENDA">Benda Asing</label></div></div>
                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="AIRWAY_DARAH" value="1" id="AIRWAY_DARAH" {{ isCheckedRm3f($row, 'AIRWAY_DARAH') }}><label class="form-check-label" for="AIRWAY_DARAH">Darah</label></div></div>
                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="AIRWAY_SPUTUM" value="1" id="AIRWAY_SPUTUM" {{ isCheckedRm3f($row, 'AIRWAY_SPUTUM') }}><label class="form-check-label" for="AIRWAY_SPUTUM">Sputum</label></div></div>
                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="AIRWAY_LENDIR" value="1" id="AIRWAY_LENDIR" {{ isCheckedRm3f($row, 'AIRWAY_LENDIR') }}><label class="form-check-label" for="AIRWAY_LENDIR">Lendir</label></div></div>
                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="AIRWAY_BRONCHOSPASME" value="1" id="AIRWAY_BRONCHOSPASME" {{ isCheckedRm3f($row, 'AIRWAY_BRONCHOSPASME') }}><label class="form-check-label" for="AIRWAY_BRONCHOSPASME">Bronchospasme</label></div></div>
                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="AIRWAY_NORMAL" value="1" id="AIRWAY_NORMAL" {{ isCheckedRm3f($row, 'AIRWAY_NORMAL') }}><label class="form-check-label" for="AIRWAY_NORMAL">Normal</label></div></div>
                        <div class="col">
                            <div class="form-check"><input class="form-check-input" type="checkbox" name="AIRWAY_LAIN" value="1" id="AIRWAY_LAIN" {{ isCheckedRm3f($row, 'AIRWAY_LAIN') }}><label class="form-check-label" for="AIRWAY_LAIN">Lainnya</label></div>
                            <input type="text" id="AIRWAY_KET_LAIN" name="AIRWAY_KET_LAIN" class="form-control form-control-sm mt-1" placeholder="Keterangan Lainnya" value="{{ getValueRm3f($row, 'AIRWAY_KET_LAIN') }}" style="display: {{ isCheckedRm3f($row, 'AIRWAY_LAIN') ? 'block' : 'none' }};">
                        </div>
                    </div>
                </div>
                ...
                <!-- Breathing -->
                <div class="mb-4 border-bottom pb-3">
                    <h4 class="h5 mb-3 text-success"><i class="fas fa-wind me-2"></i><strong>Breathing</strong></h4>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <h5 class="h6 mb-2"><strong>Sesak Nafas:</strong></h5>
                        ...
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <label for="BREATH_FREKUENSI" class="form-label">Frekuensi Pernapasan:</label>
                                            <div class="input-group input-group-sm"><input type="text" id="BREATH_FREKUENSI" name="BREATH_FREKUENSI" class="form-control" value="{{ getValueRm3f($row, 'PACS2_NAFAS') }}"><span class="input-group-text">x/menit</span></div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Irama Pernapasan:</label>
                ...
                <!-- Circulation -->
                <div class="mb-4 border-bottom pb-3">
                    <h4 class="h5 mb-3 text-success"><i class="fas fa-heartbeat me-2"></i><strong>Circulation</strong></h4>
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <div class="card bg-light h-100">
                                <div class="card-body p-3">
                                    <label for="CIRCU_TD" class="form-label">Tekanan Darah:</label>
                                    <div class="input-group input-group-sm"><input type="text" id="CIRCU_TD" name="CIRCU_TD" class="form-control" value="{{ getValueRm3f($row, 'PACS1_TD') }}"><span class="input-group-text">mmHg</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card bg-light h-100">
                                <div class="card-body p-3">
                                    ...
                                    <div class="input-group input-group-sm mb-2"><input type="text" id="CIRCU_NADI" name="CIRCU_NADI" class="form-control" value="{{ getValueRm3f($row, 'PACS1_NADI') }}"><span class="input-group-text">x/menit</span></div>
                                    <div class="row g-1">
                                        <div class="col-6">
                        ...
                        <div class="col-md-4">
                            <div class="card bg-light h-100">
                                <div class="card-body p-3">
                                    ...
                                    <div class="input-group input-group-sm"><input type="text" id="CIRCU_SATURASI" name="CIRCU_SATURASI" class="form-control" value="{{ getValueRm3f($row, 'PACS3_SATURASI') }}"><span class="input-group-text">%</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-3">
                            <div class="card bg-light h-100">
                                <div class="card-body p-3">
                                    <label class="form-label"><strong>CRT:</strong></label>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-light h-100">
                                <div class="card-body p-3">
                                    <label class="form-label"><strong>Ekstremitas atas dan bawah:</strong></label>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-light h-100">
                                <div class="card-body p-3">
                                    <label class="form-label"><strong>Turgor Kulit:</strong></label>
                        ...
                        <div class="col-md-3">
                            <div class="card bg-light h-100">
                                <div class="card-body p-3">
                                    <label class="form-label"><strong>Warna Kulit:</strong></label>
                ...
                <!-- Disability -->
                <div class="mb-4 border-bottom pb-3">
                    <h4 class="h5 mb-3 text-success"><i class="fas fa-brain me-2"></i><strong>Disability</strong></h4>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <label for="DISAB_KESADARAN" class="form-label">Kesadaran:</label>
                                    <input type="text" id="DISAB_KESADARAN" name="DISAB_KESADARAN" class="form-control form-control-sm" value="{{ getValueRm3f($row, 'KESADARAN') }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-4">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" class="form-control gcs-input-rm3f" id="DISAB_GCS_E" name="DISAB_GCS_E" min="1" max="4" value="{{ getValueRm3f($row, 'GCS_E') }}" placeholder="Eye">
                                            </div>
                                        </div>
                                        <div class="col-4"><label class="form-label d-none d-md-block" style="visibility: hidden;">GCS</label><div class="input-group input-group-sm"><span class="input-group-text">V</span><input type="number" class="form-control gcs-input-rm3f" id="DISAB_GCS_V" name="DISAB_GCS_V" min="1" max="5" value="{{ getValueRm3f($row, 'GCS_V') }}" placeholder="Verbal"></div></div>
                                        <div class="col-4"><label class="form-label d-none d-md-block" style="visibility: hidden;">GCS</label><div class="input-group input-group-sm"><span class="input-group-text">M</span><input type="number" class="form-control gcs-input-rm3f" id="DISAB_GCS_M" name="DISAB_GCS_M" min="1" max="6" value="{{ getValueRm3f($row, 'GCS_M') }}" placeholder="Motorik"></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    ...
                                    <input type="text" id="DISAB_PUPIL" name="DISAB_PUPIL" class="form-control form-control-sm mb-2" value="{{ getValueRm3f($row, 'DISAB_PUPIL') }}">
                ...
                <!-- Exposure -->
                <div class="mb-4">
                    <h4 class="h5 mb-3 text-success"><i class="fas fa-search me-2"></i><strong>Exposure</strong></h4>
                    <div class="card bg-light">
                        <div class="card-body p-3">
                            <h5 class="h6 mb-2"><strong>Luka:</strong></h5>
                            ...
                            <div id="exposureForm" class="mt-3" style="display: {{ isCheckedRm3f($row, 'EXPOSURE_LUKA_ADA') ? 'block' : 'none' }};">
                                <div class="row g-2">
                                    <div class="col-md-6"><label for="EXPOSURE_LUKA" class="form-label">Keadaan Luka:</label><input type="text" id="EXPOSURE_LUKA" name="EXPOSURE_LUKA" class="form-control form-control-sm" value="{{ getValueRm3f($row, 'EXPOSURE_LUKA') }}"></div>
                                    <div class="col-md-6"><label for="EXPOSURE_KEDALAMAN" class="form-label">Kedalaman:</label><input type="text" id="EXPOSURE_KEDALAMAN" name="EXPOSURE_KEDALAMAN" class="form-control form-control-sm" value="{{ getValueRm3f($row, 'EXPOSURE_KEDALAMAN') }}"></div>
                                    <div class="col-md-6"><label for="EXPOSURE_PERDARAHAN" class="form-label">Perdarahan:</label><input type="text" id="EXPOSURE_PERDARAHAN" name="EXPOSURE_PERDARAHAN" class="form-control form-control-sm" value="{{ getValueRm3f($row, 'EXPOSURE_PERDARAHAN') }}"></div>
                                    <div class="col-md-6"><label for="EXPOSURE_FRAKTUR" class="form-label">Fraktur/dislokasi:</label><input type="text" id="EXPOSURE_FRAKTUR" name="EXPOSURE_FRAKTUR" class="form-control form-control-sm" value="{{ getValueRm3f($row, 'EXPOSURE_FRAKTUR') }}"></div>
                                    <div class="col-12"><label for="EXPOSURE_LOKASI" class="form-label">Lokasi:</label><input type="text" id="EXPOSURE_LOKASI" name="EXPOSURE_LOKASI" class="form-control form-control-sm" value="{{ getValueRm3f($row, 'EXPOSURE_LOKASI') }}"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Asesmen Nyeri -->
        <div class="card mb-4">
            <div class="card-header bg-success text-white"><h3 class="h5 mb-0">ASESMEN NYERI</h3></div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                <h4 class="h6 mb-2"><strong>Apakah Terdapat Keluhan Nyeri?</strong></h4>
                ...
                <div id="nyeriForm" class="border-top pt-3" style="display: {{ isCheckedRm3f($row, 'NYERI_YA3B') ? 'block' : 'none' }};">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <div class="card bg-light h-100">
                                <div class="card-body p-3">
                                    <label for="SKALA_NYERI" class="form-label">Skala Nyeri:</label>
                                    <input type="text" id="SKALA_NYERI" name="SKALA_NYERI" class="form-control form-control-sm" value="{{ getValueRm3f($row, 'NYERI_YA_KET') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <h5 class="h6 mb-2"><strong>Metode Penilaian:</strong></h5>
                                    <div class="row row-cols-2 row-cols-md-3 g-2">
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="METODE_VAS" value="1" id="METODE_VAS" {{ isCheckedRm3f($row, 'VAS') }}><label class="form-check-label" for="METODE_VAS">VAS</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="METODE_WONGBAKER" value="1" id="METODE_WONGBAKER" {{ isCheckedRm3f($row, 'WONG') }}><label class="form-check-label" for="METODE_WONGBAKER">Wong-Baker</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="METODE_FLACC" value="1" id="METODE_FLACC" {{ isCheckedRm3f($row, 'FLACC') }}><label class="form-check-label" for="METODE_FLACC">FLACC</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="METODE_NIPS" value="1" id="METODE_NIPS" {{ isCheckedRm3f($row, 'NIPS') }}><label class="form-check-label" for="METODE_NIPS">NIPS</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="METODE_SKOR" value="1" id="METODE_SKOR" {{ isCheckedRm3f($row, 'METODE_SKOR') }}><label class="form-check-label" for="METODE_SKOR">Skor</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="METODE_KATEGORI" value="1" id="METODE_KATEGORI" {{ isCheckedRm3f($row, 'METODE_KATEGORI') }}><label class="form-check-label" for="METODE_KATEGORI">Kategori</label></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <h5 class="h6 mb-2"><strong>Apakah Nyerinya berpindah dari tempat satu ketempat lain?</strong></h5>
                                    <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" name="NYERI_PINDAH_TIDAK" value="1" id="NYERI_PINDAH_TIDAK" {{ isCheckedRm3f($row, 'NYERI_PINDAH_TIDAK') }}><label class="form-check-label" for="NYERI_PINDAH_TIDAK">Tidak Pindah</label></div>
                                    <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" name="NYERI_PINDAH_YA" value="1" id="NYERI_PINDAH_YA" {{ isCheckedRm3f($row, 'NYERI_PINDAH_YA') }}><label class="form-check-label" for="NYERI_PINDAH_YA">Pindah</label></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <h5 class="h6 mb-2"><strong>Berapa lama nyeri ini?</strong></h5>
                                    <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" name="LAMA_NYERI_AKUT" value="1" id="LAMA_NYERI_AKUT" {{ isCheckedRm3f($row, 'LAMA_NYERI_AKUT') }}><label class="form-check-label" for="LAMA_NYERI_AKUT">&lt; 3 Bulan=Akut</label></div>
                                    <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" name="LAMA_NYERI_KRONIK" value="1" id="LAMA_NYERI_KRONIK" {{ isCheckedRm3f($row, 'LAMA_NYERI_KRONIK') }}><label class="form-check-label" for="LAMA_NYERI_KRONIK">&gt; 3 Bulan = Kronik</label></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <h5 class="h6 mb-2"><strong>Rasa Nyeri</strong></h5>
                                    <div class="row row-cols-2 row-cols-md-3 g-2">
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_TAJAM" value="1" id="RASA_TAJAM" {{ isCheckedRm3f($row, 'RASA_TAJAM') }}><label class="form-check-label" for="RASA_TAJAM">Tajam</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_DISUTUK" value="1" id="RASA_DISUTUK" {{ isCheckedRm3f($row, 'RASA_DISUTUK') }}><label class="form-check-label" for="RASA_DISUTUK">Seperti ditusuk</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_BERDENYUT" value="1" id="RASA_BERDENYUT" {{ isCheckedRm3f($row, 'RASA_BERDENYUT') }}><label class="form-check-label" for="RASA_BERDENYUT">Seperti Berdenyut</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_TUMPUL" value="1" id="RASA_TUMPUL" {{ isCheckedRm3f($row, 'RASA_TUMPUL') }}><label class="form-check-label" for="RASA_TUMPUL">Nyeri Tumpul</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_DIPUKUL" value="1" id="RASA_DIPUKUL" {{ isCheckedRm3f($row, 'RASA_DIPUKUL') }}><label class="form-check-label" for="RASA_DIPUKUL">Seperti dipukul</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_DITIKAM" value="1" id="RASA_DITIKAM" {{ isCheckedRm3f($row, 'RASA_DITIKAM') }}><label class="form-check-label" for="RASA_DITIKAM">Seperti ditikam</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_DITARIK" value="1" id="RASA_DITARIK" {{ isCheckedRm3f($row, 'RASA_DITARIK') }}><label class="form-check-label" for="RASA_DITARIK">Nyeri Ditarik</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_DIBAKAR" value="1" id="RASA_DIBAKAR" {{ isCheckedRm3f($row, 'RASA_DIBAKAR') }}><label class="form-check-label" for="RASA_DIBAKAR">Seperti Dibakar</label></div></div>
                                        <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" name="RASA_KRAM" value="1" id="RASA_KRAM" {{ isCheckedRm3f($row, 'RASA_KRAM') }}><label class="form-check-label" for="RASA_KRAM">Seperti Kram</label></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <h5 class="h6 mb-2"><strong>Seberapa sering anda mengalami nyeri? Berapa lama?</strong></h5>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check"><input class="form-check-input" type="checkbox" name="NYERI_KRNG30MNT" value="1" id="NYERI_KRNG30MNT" {{ isCheckedRm3f($row, 'NYERI_KRNG30MNT') }}><label class="form-check-label" for="NYERI_KRNG30MNT">Kurang dari 30 Menit</label></div>
                                            <div class="form-check"><input class="form-check-input" type="checkbox" name="NYERI_LBH30MNT" value="1" id="NYERI_LBH30MNT" {{ isCheckedRm3f($row, 'NYERI_LBH30MNT') }}><label class="form-check-label" for="NYERI_LBH30MNT">Lebih dari 30 Menit</label></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    <h5 class="h6 mb-2"><strong>Apakah yang membuat nyeri berkurang?</strong></h5>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="form-check"><input class="form-check-input" type="checkbox" name="NYERI_LAIN" value="1" id="NYERI_LAIN" {{ isCheckedRm3f($row, 'NYERI_LAIN') }}><label class="form-check-label" for="NYERI_LAIN">Lain-lain</label></div>
                                            <div id="NYERI_LAIN_KET_CONTAINER" class="mt-2" style="{{ isCheckedRm3f($row, 'NYERI_LAIN') ? '' : 'display: none;' }}"><input type="text" id="NYERI_LAIN_KET" name="NYERI_LAIN_KET" class="form-control form-control-sm" placeholder="Keterangan Lainnya" value="{{ getValueRm3f($row, 'NYERI_LAIN_KET') }}"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="card mb-4">
            <div class="card-header bg-success text-white"><h3 class="h5 mb-0">DIAGNOSA DAN RENCANA</h3></div>
            <div class="card-body">
                <div class="mb-3"><label for="DIAGNOSA_KPRWTN" class="form-label">Diagnosa Keperawatan:</label><textarea id="DIAGNOSA_KPRWTN" name="DIAGNOSA_KPRWTN" class="form-control" rows="3">{{ getValueRm3f($row, 'DIAGNOSA_KPRWTN') }}</textarea></div>
                <div class="mb-3"><label for="RENCANA_KPRWTN" class="form-label">Rencana Keperawatan:</label><textarea id="RENCANA_KPRWTN" name="RENCANA_KPRWTN" class="form-control" rows="3">{{ getValueRm3f($row, 'RENCANA_KPRWTN') }}</textarea></div>
                <div class="mb-3"><label for="TINDAKAN" class="form-label">Tindakan:</label><textarea id="TINDAKAN" name="TINDAKAN" class="form-control" rows="3">{{ getValueRm3f($row, 'TINDAKAN') }}</textarea></div>
                <div class="mb-3"><label for="EVALUASI" class="form-label">Evaluasi:</label><textarea id="EVALUASI" name="EVALUASI" class="form-control" rows="3">{{ getValueRm3f($row, 'EVALUASI') }}</textarea></div>
            </div>
        </div>

        <!-- Tindakan Medis -->
        <div class="card mb-4">
            <div class="card-header bg-success text-white"><h3 class="h5 mb-0">TINDAKAN MEDIS</h3></div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-check"><input class="form-check-input" type="checkbox" name="LAINNYA" value="1" id="LAINNYA" {{ isCheckedRm3f($row, 'LAINNYA') }}><label class="form-check-label" for="LAINNYA">Lainnya</label></div>
                        <div class="col-md-6" id="lainnyaKetContainer" style="display: {{ isCheckedRm3f($row, 'LAINNYA') ? 'block' : 'none' }};"><label for="LAINNYA_KET" class="form-label">Keterangan Lainnya:</label><input type="text" id="LAINNYA_KET" name="LAINNYA_KET" class="form-control" value="{{ getValueRm3f($row, 'LAINNYA_KET') }}"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- OBAT -->
        <div class="card mb-4">
            <div class="card-header bg-success text-white"><h3 class="h5 mb-0">OBAT</h3></div>
            <div class="card-body">
                <div class="mb-4">
                    <div class="form-check mb-3"><input class="form-check-input" type="checkbox" name="OBAT_ORAL" value="1" id="OBAT_ORAL" {{ isCheckedRm3f($row, 'OBAT_ORAL') }}><label class="form-check-label" for="OBAT_ORAL">Oral</label></div>
                    <div class="row g-3" id="OBAT_ORAL_CONTAINER" style="{{ isCheckedRm3f($row, 'OBAT_ORAL') ? '' : 'display: none;' }}">
                        <div class="col-md-12"><label for="OBAT_ORAL_KET" class="form-label">Obat Oral:</label><textarea id="OBAT_ORAL_KET" name="OBAT_ORAL_KET" class="form-control" rows="3">{{ getValueRm3f($row, 'OBAT_ORAL_KET') }}</textarea></div>
                    </div>
                </div>
                <div class="mb-4">
                    <div class="form-check mb-3"><input class="form-check-input" type="checkbox" name="OBAT_PARENTERAL" value="1" id="OBAT_PARENTERAL" {{ isCheckedRm3f($row, 'OBAT_PARENTERAL') }}><label class="form-check-label" for="OBAT_PARENTERAL">Parenteral</label></div>
                    <div class="row g-3" id="OBAT_PARENTERAL_CONTAINER" style="{{ isCheckedRm3f($row, 'OBAT_PARENTERAL') ? '' : 'display: none;' }}">
                        <div class="col-md-12"><label for="OBAT_PARENTERAL_KET" class="form-label">Obat Parenteral:</label><textarea id="OBAT_PARENTERAL_KET" name="OBAT_PARENTERAL_KET" class="form-control" rows="3">{{ getValueRm3f($row, 'OBAT_PARENTERAL_KET') }}</textarea></div>
                    </div>
                </div>
                <div class="mb-4">
                    <div class="form-check mb-3"><input class="form-check-input" type="checkbox" name="OBAT_LAIN" value="1" id="OBAT_LAIN" {{ isCheckedRm3f($row, 'OBAT_LAIN') }}><label class="form-check-label" for="OBAT_LAIN">Lain-lain</label></div>
                    <div class="row g-3" id="OBAT_LAIN_CONTAINER" style="{{ isCheckedRm3f($row, 'OBAT_LAIN') ? '' : 'display: none;' }}">
                        <div class="col-md-12"><label for="OBAT_LAIN_KET" class="form-label">Terapi Lainnya:</label><textarea id="OBAT_LAIN_KET" name="OBAT_LAIN_KET" class="form-control" rows="3">{{ getValueRm3f($row, 'OBAT_LAIN_KET') }}</textarea></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-footer bg-white">
            ...
            <button type="button" class="btn btn-outline-danger" id="reset-rm3f"><i class="fas fa-times-circle"></i> Batal / Reset</button>
        </div>
    </form>
</div>
...
$(document).ready(function() {
    ...
    // Fungsi untuk checkbox eksklusif dengan toggle
    function exclusiveCheckboxWithToggle(checkboxYesId, checkboxNoId, containerId) {
        const checkboxYes = $(`#${checkboxYesId}`);
        const checkboxNo = $(`#${checkboxNoId}`);
        const container = $(`#${containerId}`);
    ...
    exclusiveCheckbox('sesak-detail');
    exclusiveCheckbox('irama-pernapasan');

    // Circulation
    exclusiveCheckbox('crt-checkbox');
    exclusiveCheckbox('extremitas-checkbox');
    exclusiveCheckbox('turgor-checkbox');
    exclusiveCheckbox('warna-kulit');
    exclusiveCheckbox('pupil-disability');
    ...
    function calculateGCS_rm3f() {
        ...
        else if (totalGCS <= 6) kesadaran = 'Soporocomatous';
        else if (totalGCS <= 9) kesadaran = 'Somnolen';
        else if (totalGCS <= 11) kesadaran = 'Delirium';
        else if (totalGCS <= 13) kesadaran = 'Apatis';
